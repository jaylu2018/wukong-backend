...
class MenuBase(CRUDBaseSchema):
    ...
    sort: Optional[int] = Field(0,description="菜单顺序")
    ...
    keep_alive: Optional[bool] = Field(True, description="是否缓存")
    visible_flag: Optional[bool] = Field(alias="visibleFlag", description="是否可见")
    disabled_flag: bool = Field(alias='disabledFlag', description="状态")
    web_permission: Optional[str] = Field(None, alias="webPerms", description="前端权限")
    api_permission: Optional[str] = Field(None, alias="apiPerms", description="后段权限")
